...
| `cross_attn_focal_tuned` | `hemit_fm_cross_attn_scratch_focal_tuned` (γ=0.75, global, no vel) |
| `cross_attn_focal_tuned_vel` | `hemit_fm_cross_attn_scratch_focal_tuned_vel` (γ=0.75 + light vel) |
| `cross_attn_focal_g075` | `hemit_fm_cross_attn_scratch_focal_g075` (γ=0.6, global, no vel) |
